            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="Family Name"><?php echo $row['family_name']; ?></td>
                        <td data-label="Email"><?php echo $row['email']; ?></td>
                        <td data-label="Password"><?php echo $row['password']; ?></td>
                        <td data-label="Mobile Number"><?php echo $row['mobile_number']; ?></td>
                        <td data-label="Role"><?php echo $role_name; ?></td>
                        <td data-label="Confirm Password"><?php echo $row['confirm_password']; ?></td>
                        <td>
                            <a href="edit.php?user_id=<?php echo $row['user_id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="delete.php?user_id=<?php echo $row['user_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this record?')">Delete</a>
                            <a href="show.php?user_id=<?php echo $row['user_id']; ?>" class="btn btn-light"> <i class="bi bi-eye"></i> </a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
